...
router.post('/addItem', validate, uploads.single('image'), addItemController.itemSchema);
...
router.post('/updateById/:id', validate, userController.updatePasswordById);  //update via id
